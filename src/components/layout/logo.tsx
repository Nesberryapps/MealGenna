  ...
  return (
    ...
    >
      ...
      <g transform="translate(0, -5) scale(1)">
        ...
        />
        <g stroke="hsl(var(--primary-foreground))" strokeWidth="2" strokeLinecap="round">
            <path d="M 47.5,10 L 47.5, 30" />
            <path d="M 45,15 L 50,15" />
            <path d="M 42.5,10 L 42.5, 30" />
            <path d="M 52.5,10 L 52.5,30" />
        </g>
        <path
